...
/**
 * Created by shubham.srivastava on 06/03/17.
 */
public class FinalOrderAdapter extends RecyclerView.Adapter {
  private ArrayList<CheckOutItem> checkOutItemArrayList;
  private Context mContext;
  public FinalOrderAdapter(Context context,ArrayList<CheckOutItem> checkOutItemArrayList) {
  ...
  public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    View itemLayoutView = LayoutInflater.from(parent.getContext())
        .inflate(R.layout.final_order_item, null);
